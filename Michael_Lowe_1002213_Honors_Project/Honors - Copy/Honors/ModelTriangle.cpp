...
bool  ModelTriangle::Initialize(ID3D11Device* device, WCHAR* textureFilename)
{
	bool result;
...
ID3D11ShaderResourceView*  ModelTriangle::GetTexture()
{
...
bool  ModelTriangle::LoadTexture(ID3D11Device* device, WCHAR* filename)
{
	bool result;


	// Create the texture object.
	m_Texture = new Texturing;
	if(!m_Texture)
	{
		return false;
	}
...
void  ModelTriangle::ReleaseTexture()
{
